...
class PrimePopUpScreenView extends StatefulWidget {
  const PrimePopUpScreenView({super.key});

  @override
  State<PrimePopUpScreenView> createState() => _PrimePopUpScreenViewState();
}

class _PrimePopUpScreenViewState extends State<PrimePopUpScreenView> {
  @override
