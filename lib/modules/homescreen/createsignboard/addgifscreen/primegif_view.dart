...
class PrimePopUpGifScreenView extends StatefulWidget {
  const PrimePopUpGifScreenView({super.key});

  @override
  State<PrimePopUpGifScreenView> createState() =>
      _PrimePopUpGifScreenViewState();
}

class _PrimePopUpGifScreenViewState extends State<PrimePopUpGifScreenView> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 8, right: 8),
                child: Text(
                  AppConstants.preminumGifAmount,
                  textAlign: TextAlign.center,
                  style: TextStyle(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: RichText(
                    ...
                    maxLines: 3,
                    text: TextSpan(
                      text: AppConstants.gifPayAmount,
